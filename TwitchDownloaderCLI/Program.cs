...
namespace TwitchDownloaderCLI
{
    internal static partial class Program
    {
        private static void Main(string[] args)
        {
            ...
            var parserResult = parser.ParseArguments<VideoDownloadArgs, ClipDownloadArgs, ChatDownloadArgs, ChatUpdateArgs, ChatMergeArgs, ChatRenderArgs, InfoArgs, FfmpegArgs, CacheArgs, UpdateArgs, TsMergeArgs>(preParsedArgs);
            ...
            parserResult
                ...
                .WithParsed<ChatMergeArgs>(MergeChats.Merge)
